...
class MyGUI:
    def __init__(self):
        ...
        self.prompt_label = tkinter.Label(self.mid_frame,text='No. of minutes:')
...
#I read the instructions wrong. I messed up the calculation
      


        # Display the message in an info dialog box.
        tkinter.messagebox.showinfo('Total Cost', '${:,.2f}'.format(cost))
